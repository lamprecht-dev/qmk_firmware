 ...
 * |      |   Q  |   W  |   E  |   R  |   T  |                    |   Y  |   U  |   I  |   O  |   P  |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |LGUI/A|ALT/S |SFT/D |CTR/F |   G  |-------.    ,-------|   H  | CTR/J| SFT/K| ALT/L| GUI/;|   '  |
 * |------+------+------+------+------+------| MUTE  |    |DISCORD|------+------+------+------+------+------|
 * |      |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *           |       | CAPSL|LOWER | Tab  | / Space /       \Enter \  | Bspc  |RAISE |NUMPAD|      |
 *            |      |      |      |      |/ LMOD  /         \ RMOD \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
  [_QWERTY] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  XXXXXXX,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_MY_MUTE,  KC_D_MUTE,KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, XXXXXXX,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 XXXXXXX, KC_CAPS_LOCK, KC_LOWER, KC_TAB, LT(_LMOD, KC_SPC),LT(_RMOD, KC_ENT), KC_BSPC,  KC_RAISE, TO(_NUMPAD), XXXXXXX
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
[_LMOD] = LAYOUT(
...
[_LOWER] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_PGDN, XXXXXXX,
...
[_NUMPAD] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3, KC_DOT, XXXXXXX,
                      XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______, _______, TO(_QWERTY), XXXXXXX
    ),
...
[_GAMING] = LAYOUT(
         ...
         KC_G,   XXXXXXX,  KC_A,   KC_S,   KC_D,    KC_F,                       KC_H,     KC_J,   KC_K,    KC_L,   KC_SCLN,  KC_QUOT,
         KC_B,  KC_LCTL,   KC_Z,   KC_X,   KC_C,    KC_V,  _______,  _______,KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, XXXXXXX,
                  XXXXXXX, KC_CAPS_LOCK, XXXXXXX, KC_LSFT, KC_SPC, KC_ENT, KC_BSPC,  XXXXXXX, XXXXXXX, XXXXXXX
